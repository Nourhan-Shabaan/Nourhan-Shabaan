...
**Aspiring Full-Stack Developer · Science Student · Problem Solver 🚀**
...
I build web applications, solve problems, and continuously learn new technologies.

Currently focusing on Full-Stack Development with **C# and .NET** while strengthening my frontend skills with **HTML, CSS, JavaScript, and Bootstrap**.

My goal is to design and develop scalable, high-performance web applications that deliver real value to users.

🎓 Science Student (2nd Year)

💻 Passionate about Web Development and Software Engineering

📚 Constantly learning new technologies and best practices

🌍 Improving my English skills to collaborate with global teams
...
<img src="https://img.shields.io/badge/ASP.NET-5C2D91?logo=dotnet&logoColor=white" alt="ASP.NET"/>
...
🚗 Responsive Car Showroom Website

💻 Coding Challenge Platform Inspired by LeetCode

📝 Dynamic Application Forms System
